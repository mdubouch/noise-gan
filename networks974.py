...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw3 = nn.Conv1d(n512//16, n512//16, 3, 1, 1)
        self.bnw3 = nn.InstanceNorm1d(n512//16)
        ...
        self.bnp2 = nn.InstanceNorm1d(n512//16)
    ...
    def forward(self, z):
        ...
        w = self.bnw3(self.act(self.convw3(self.dropout(w0))))
        ...
        p = self.bnp2(self.act(self.convp2(self.dropout(p0))))
        p = self.convp1(p)
