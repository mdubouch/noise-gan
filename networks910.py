...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convgeom1 = nn.Conv1d(n64*2, n64*2, 9, 1, 4, padding_mode='circular')
        self.convgeom2 = nn.Conv1d(n64*2, n64*2, 5, 1, 2, padding_mode='circular')
        self.convgeom3 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')

        self.conv1 = nn.Conv1d(n64*3, n128, 9, 1, 4, padding_mode='circular')
        self.conv2 = nn.Conv1d(n128, n256, 5, 1, 2, padding_mode='circular')
        self.conv3 = nn.Conv1d(n256, n512, 3, 1, 1, padding_mode='circular')
