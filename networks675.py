...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(geom_dim, n64, 12, 2, 0))

        self.conv1 = nn.utils.spectral_norm(nn.Conv1d(n64, n128, 12, 2, 0))

        self.conv2 = nn.utils.spectral_norm(nn.Conv1d(n128, n256, 12, 2, 0))
        self.conv3 = nn.utils.spectral_norm(nn.Conv1d(n256, n512, 12, 2, 0))
        self.conv4 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 12, 2, 0))
        self.conv5 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 12, 2, 0))
