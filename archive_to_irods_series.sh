...
# Handles a job series all at once. A series corresponds to all jobs that have the same
# digit in the millions, e.g. 1001337 is the same series as 1000000, 2123456 is not.
