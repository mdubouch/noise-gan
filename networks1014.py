...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw4 = nn.Conv1d(n512//32, n512//32, 3, 1, 1)
        self.bnw4 = nn.InstanceNorm1d(n512//32)
        self.convw3 = nn.Conv1d(n512//32, n512//32, 3, 1, 1)
        self.bnw3 = nn.InstanceNorm1d(n512//32)
        ...
        self.convp3 = nn.Conv1d(n512//32, n512//32, 3, 1, 1)
        self.bnp3 = nn.InstanceNorm1d(n512//32)
        self.convp2 = nn.Conv1d(n512//32, n512//32, 3, 1, 1)
        self.bnp2 = nn.InstanceNorm1d(n512//32)
    ...
    def forward(self, z):
        ...
        w = self.bw3(w)
        w = self.bnw4(self.act(self.convw4(w)))
        w = self.bnw3(self.act(self.convw3(w)))
        ...
        p = self.bp2(p)
        p = self.bnp3(self.act(self.convp3(p)))
        p = self.bnp2(self.act(self.convp2(p)))
        p = self.convp1(p)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.bc3 = nn.Conv1d(ncom*4, ncom*8, 3, 2, 1, padding_mode='circular')
