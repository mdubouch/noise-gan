...
class Gen(nn.Module):
    ...
    def forward(self, z, wire_to_xy):
        ...
        x = self.act(self.bn0(self.lin0(z).reshape(-1, self.n512, self.seq_len // 512)))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0i = nn.utils.spectral_norm(nn.Conv1d(geom_dim, n64, 17, 1, 0))
        ...
        self.conv3 = nn.utils.spectral_norm(nn.Conv1d(n256, n512, 16, 2, 0))
        self.conv4 = nn.utils.spectral_norm(nn.Conv1d(n256+n512, n512, 32, 2, 0))
