...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.resw2 = ResBlockTranspose(ngf*2, ngf*1, 257, 1, 128)
        self.resw3 = ResBlockTranspose(ngf*1, ngf*1, 513, 1, 256)
        ...
        self.resp2 = ResBlockTranspose(ngf*2, ngf*1, 33, 1, 16)
        self.resp3 = ResBlockTranspose(ngf*1, ngf*1, 513, 1, 256)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = ResBlock(ndf*1, ndf*1, 513, 1, 256, padding_mode='zeros')
        self.resw1 = ResBlock(ndf*1, ndf*2, 257, 1, 128, padding_mode='zeros')
        self.resw2 = ResBlock(ndf*2, ndf*2, 129, 1, 64, padding_mode='zeros')

        self.convp = nn.Conv1d(n_features, ndf*1, 1, 1, 0)
        self.resp0 = ResBlock(ndf*1, ndf*1, 513, 1, 256, padding_mode='zeros')
        self.resp1 = ResBlock(ndf*1, ndf*2, 33, 1, 16, padding_mode='zeros')
