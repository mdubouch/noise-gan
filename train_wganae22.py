...
optimizer_gen = torch.optim.AdamW(gen.parameters(),  lr=1e-4, betas=(0.5, 0.9))
optimizer_disc = torch.optim.AdamW(disc.parameters(), lr=1e-4, betas=(0.5, 0.9))
...
for e in range(start_epoch, start_epoch + n_epochs):
    ...
    for i, (real_p, real_w) in enumerate(train_loader):
        ...
        enc_loss = ae_loss + 1.0 * dist_loss
