...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convxy1 = nn.utils.spectral_norm(nn.Conv1d(geom_dim, n64, 3, 1, 1))
        self.convxy2 = nn.utils.spectral_norm(nn.Conv1d(n64, n64, 3, 1, 1))
        self.convxy3 = nn.utils.spectral_norm(nn.Conv1d(n64, n64, 3, 1, 1))
        self.convp1 = nn.utils.spectral_norm(nn.Conv1d(n_features, n64, 3, 1, 1))

        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(n64 + n64, n192, 3, 1, 1))
