...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw4 = nn.ConvTranspose1d(32, 8, 3, 1, 1)
        self.bnw4 = nn.InstanceNorm1d(8)
        self.convw5 = nn.ConvTranspose1d(8, 1, 3, 1, 1)
        self.bnw5 = nn.InstanceNorm1d(1)
        self.convw6 = nn.ConvTranspose1d(1, n_wires, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.Conv1d(n_features+2, 128, 1, 1, 0)
