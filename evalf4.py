...
# Initialize networks
gen = nn.DataParallel(networks.Gen(ngf=ngf, latent_dims=latent_dims, seq_len=seq_len, 
    encoded_dim=encoded_dim, n_wires=gu.n_wires).to(device))
disc = nn.DataParallel(networks.Disc(ndf=ndf, seq_len=seq_len, encoded_dim=encoded_dim,
