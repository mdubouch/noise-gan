...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw3 = nn.Conv1d(64, 64, 17, 1, 8)
        self.bnw3 = nn.BatchNorm1d(64)
        self.convw4 = nn.Conv1d(64, n_wires, 1, 1, 0, bias=False)

        self.convp1 = nn.Conv1d(64, 64, 3, 1, 1)
        self.bnp1 = nn.BatchNorm1d(64)
        self.convp2 = nn.Conv1d(64, 32, 3, 1, 1)
        self.bnp2 = nn.BatchNorm1d(32)
        self.convp3 = nn.Conv1d(32, n_features, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convxy3 = nn.Conv1d(64, 64, 9, 1, 4)
