...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.bnd1 = LayerNorm(ndf*6)
        self.bnd2 = LayerNorm(ndf*6)
        self.bnd3 = LayerNorm(ndf*6)
        self.bnd4 = LayerNorm(ndf*6)
        self.bnd5 = LayerNorm(ndf*6)
        self.bnd6 = LayerNorm(ndf*6)
        self.bn1 = LayerNorm(ndf*6)
        self.bn2 = LayerNorm(ndf*6)
        self.bn3 = LayerNorm(ndf*6)
        self.bn4 = LayerNorm(ndf*6)
        self.bn5 = LayerNorm(ndf*6)
        self.bn6 = LayerNorm(ndf*6)
