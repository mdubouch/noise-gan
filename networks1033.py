...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.b4 = ResBlock(n64)
        self.convd5 = nn.Conv1d(n64, n64*2, 3, 2, 1)
        self.b6 = ResBlock(n64*2)
        self.b7 = ResBlock(n64*2)
        self.b8 = ResBlock(n64*2)
        

        self.lin0 = nn.Linear(n64*2, 1)
