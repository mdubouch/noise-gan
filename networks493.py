...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convp1 = nn.Conv1d(64, 64, 17, 1, 8)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.db2 = DBlock(512, 768)
        self.db3 = DBlock(768, 768)
        self.db4 = DBlock(768, 768)
    ...
    def forward(self, x_):
        ...
        w = self.convw(torch.clamp(wg + torch.randn_like(wg) * 0.02, 0, 1))
        p = self.convp(p)
