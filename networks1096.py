...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.b1 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.b2 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.b3 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.b4 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.b5 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.b6 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.b7 = Simple(n512, n256, 3, 2, 1, output_padding=1)
        self.b8 = Simple(n256, n128, 3, 2, 1, output_padding=1)
        self.b9 = Simple(n128, n64, 3, 2, 1, output_padding=1)
        self.b10 = Simple(n64, n64, 3, 1, 1)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv2 = nn.Conv1d(n64, n128, 3, 2, 1)
        self.conv3 = nn.Conv1d(n128, n256, 3, 2, 1)
        self.conv4 = nn.Conv1d(n256, n512, 3, 2, 1)
        self.conv5 = nn.Conv1d(n512, n512, 3, 2, 1)
        self.conv6 = nn.Conv1d(n512, n512, 3, 2, 1)
        self.conv7 = nn.Conv1d(n512, n512, 3, 2, 1)
        self.conv8 = nn.Conv1d(n512, n512, 3, 2, 1)
        self.conv9 = nn.Conv1d(n512, n512, 3, 2, 1)
        self.conv10 = nn.Conv1d(n512, n512, 3, 2, 1)
