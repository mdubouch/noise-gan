...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(ngf, 256, 1, 1, 0)
        self.convw2 = nn.ConvTranspose1d(256, encoded_dim, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw1 = nn.Conv1d(encoded_dim, 256, 1, 1, 0)
        self.convw2 = nn.Conv1d(256, ndf, 1, 1, 0)
