...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.xyemb = nn.Conv1d(geom_dim, emb_dim, 1, 1, 0, bias=False)
        ...
        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(emb_dim, n192, 3, 1, 1))

        n256 = n64 * 4
        self.conv1 = nn.utils.spectral_norm(nn.Conv1d(n192, n256, 3, 1, 0))

        n512 = n256 * 2
        self.conv2 = nn.utils.spectral_norm(nn.Conv1d(n256, n512, 3, 1, 0))
        self.conv3 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 3, 1, 0))
        self.conv4 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 3, 1, 0))
        self.conv5 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 3, 1, 0))
    ...
    def forward(self, x_): 
        ...
        xy = self.xyemb(xy)# + torch.randn_like(xy) * 0.01)
