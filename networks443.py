...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv1 = nn.ConvTranspose1d(n_wires, n_wires, 1, 1, 0)
        self.conv2 = nn.ConvTranspose1d(n_wires, n_wires, 1, 1, 0)
        self.conv3 = nn.ConvTranspose1d(n_wires, n_wires, 1, 1, 0)
