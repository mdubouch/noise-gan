...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.ln2 = nn.LayerNorm((n64,seq_len//2), elementwise_affine=False)
        self.conv3 = nn.Conv1d(n64, n128, 3, 2, 1)
        self.ln3 = nn.LayerNorm((n128,seq_len//4), elementwise_affine=False)
        self.conv4 = nn.Conv1d(n128, n256, 3, 2, 1)
        self.ln4 = nn.LayerNorm((n256,seq_len//8), elementwise_affine=False)
        self.conv5 = nn.Conv1d(n256, n512, 3, 2, 1)
        self.ln5 = nn.LayerNorm((n512,seq_len//16), elementwise_affine=False)
