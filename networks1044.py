...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv2 = nn.Conv1d(n64, n64*2, 7, 1, 3, dilation=3, padding_mode='circular')
        self.conv3 = nn.Conv1d(n64*2, n64*4, 7, 1, 27, dilation=27, padding_mode='circular')
        self.conv4 = nn.Conv1d(n64*4, n64*8, 7, 1, 243, dilation=243, padding_mode='circular')
