...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        # Common branch
        ncom = n256*3 + ncat*8
        self.convc1 = nn.Conv1d(ncom, ncom*2, 3, 1, 1, padding_mode='circular')
        self.convc2 = nn.Conv1d(ncom*2, ncom*4, 3, 1, 1, padding_mode='circular')
        self.convc3 = nn.Conv1d(ncom*4, ncom*8, 3, 1, 1, padding_mode='circular')
        self.lin0 = nn.Linear(ncom*8, 1)
        self.dropout = nn.Dropout(0.1)
