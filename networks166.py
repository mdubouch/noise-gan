...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv7 = nn.Conv1d(ngf*1, ngf*8, 1, 1, 0)
        self.bn7 = nn.InstanceNorm1d(ngf*8)

        self.convp1 = nn.ConvTranspose1d(ngf*8, ngf*4, 3, 1, 1)
        self.convp2 = nn.ConvTranspose1d(ngf*4, n_features, 1, 1, 0)

        self.convw1 = nn.ConvTranspose1d(ngf*8, ngf*8, 3, 1, 1)
        self.convw2 = nn.ConvTranspose1d(ngf*8, encoded_dim, 1, 1, 0)
