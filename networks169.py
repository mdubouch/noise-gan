...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(ngf*8, ngf*6, 9, 1, 4)
        self.conv2 = nn.Conv1d(ngf*6, ngf*4, 9, 1, 4)
        self.conv3 = nn.Conv1d(ngf*4, ngf*2, 9, 1, 4)
        self.conv4 = nn.Conv1d(ngf*2, ngf*1, 9, 1, 4)
        self.bn1 = nn.InstanceNorm1d(ngf*6)
        self.bn2 = nn.InstanceNorm1d(ngf*4)
        self.bn3 = nn.InstanceNorm1d(ngf*2)
        self.bn4 = nn.InstanceNorm1d(ngf*1)

        self.conv7 = nn.Conv1d(ngf*1, ngf*1, 9, 1, 4)
        self.bn7 = nn.InstanceNorm1d(ngf*1)

        self.convp1 = nn.ConvTranspose1d(ngf*1, ngf*1, 3, 1, 1)
        self.convp2 = nn.ConvTranspose1d(ngf*1, n_features, 257, 1, 128)

        self.convw1 = nn.ConvTranspose1d(ngf*1, ngf*1, 1, 1, 0)
        self.convw2 = nn.ConvTranspose1d(ngf*1, ngf*1, 1, 1, 0)
        self.convw3 = nn.ConvTranspose1d(ngf*1, encoded_dim, 513, 1, 256)
