...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv2 = nn.ConvTranspose1d(ngf*1, ngf*1, 1, 1, 0)
        self.bn2 = nn.InstanceNorm1d(ngf*1)
        self.conv3 = nn.ConvTranspose1d(ngf*1, ngf*1, 1, 1, 0)
    ...
    def forward(self, z, embed_space_noise=0.0, tau=1.0):
        ...
        x = self.act(self.lin0(z).view(-1, self.ngf*1, self.seq_len))
