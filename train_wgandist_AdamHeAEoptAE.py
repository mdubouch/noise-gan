...
for e in range(pretrain_epochs):
    ...
    for i in range(n_its):
        ...
        # encdec (256, 3606)
        ae_loss = ae_loss_fn(encdec, wires.squeeze(2))
        ...
        hit = (wires.squeeze(2) == choice).sum().float()
...
for e in range(start_epoch, start_epoch + n_epochs):
    ...
    for i, (real_p, real_w) in enumerate(train_loader):
        ...
        ae_loss = F.cross_entropy(real_dec_w, real_w.squeeze().cuda())
        ae_loss.backward()
