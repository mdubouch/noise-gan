...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.convp1 = nn.ConvTranspose1d(ngf*2, ngf*1, 17, 1, 8)
    ...
    def forward(self, z, embed_space_noise=0.0, tau=1.0):
        ...
        w2 = self.act(self.convw2(self.dropout(self.bnw1(self.act(w1)))))
        ...
        p1 = self.act(self.convp1(self.dropout(self.bnp0(self.act(p0)))))
        p = self.convp(p1)
