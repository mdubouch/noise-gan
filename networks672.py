...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.xyemb = nn.Conv1d(geom_dim, n64, 1, 1, 0, bias=False)

        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(n64, n128, 64, 2, 0))

        self.conv1 = nn.utils.spectral_norm(nn.Conv1d(n128, n256, 32, 2, 0))
