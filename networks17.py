...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.res4 = ResBlockTranspose(ngf*4, ngf*4, 17, 1, 8)
        self.res5 = ResBlockTranspose(ngf*4, ngf*4, 33, 1, 16)
        self.res6 = ResBlockTranspose(ngf*4, ngf*4, 49, 1, 24)
        self.res7 = ResBlockTranspose(ngf*4, ngf*2, 65, 1, 32)

        self.resw0 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        self.resw1 = ResBlockTranspose(ngf*2, ngf*2, 25, 1, 12)
        self.resw2 = ResBlockTranspose(ngf*2, ngf*2, 33, 1, 16)
        self.resw3 = ResBlockTranspose(ngf*2, n_wires, 1025, 1, 512)

        self.resp0 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        self.resp1 = ResBlockTranspose(ngf*2, ngf*2, 25, 1, 12)
        self.resp2 = ResBlockTranspose(ngf*2, ngf*2, 33, 1, 16)
        self.resp3 = ResBlockTranspose(ngf*2, n_features, 1025, 1, 512)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = ResBlock(n_wires, ndf*2, 1025, 1, 512, padding_mode='circular')
        self.resw1 = ResBlock(ndf*2, ndf*2, 33, 1, 16, padding_mode='circular')
        ...
        self.resp0 = ResBlock(n_features, ndf*2, 1025, 1, 512, padding_mode='circular')
        self.resp1 = ResBlock(ndf*2, ndf*2, 33, 1, 16, padding_mode='circular')
        ...
        self.res1 = ResBlock(ndf*4, ndf*4, 65, 1, 32, padding_mode='circular')
        self.res2 = ResBlock(ndf*4, ndf*4, 49, 1, 24, padding_mode='circular')
