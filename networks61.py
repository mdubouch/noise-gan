...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.bnu1 = LayerNorm(ngf*6)
        self.bnu2 = LayerNorm(ngf*6)
        self.bnu3 = LayerNorm(ngf*6)
        self.bnu4 = LayerNorm(ngf*6)
        self.bnu5 = LayerNorm(ngf*6)
        self.bnu6 = LayerNorm(ngf*6)
        self.bn1 = LayerNorm(ngf*6)
        self.bn2 = LayerNorm(ngf*6)
        self.bn3 = LayerNorm(ngf*6)
        self.bn4 = LayerNorm(ngf*6)
        self.bn5 = LayerNorm(ngf*6)
        self.bn6 = LayerNorm(ngf*6)
