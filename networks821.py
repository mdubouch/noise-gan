...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convg0 = nn.Conv1d(geom_dim, 32, 1, 1, 0)
        self.convg1 = nn.Conv1d(32, 32, 1, 1, 0)

        self.conv1 = nn.Conv1d(n_features+n64+32, n128, 3, 2, 0)
        self.conv2 = nn.Conv1d(n_features+n64+32+n128, n256, 3, 2, 0)
    ...
    def forward(self, x_, w_, wire_sphere): 
        ...
        w0 = self.convw0(wg)
        g0 = self.convg1(self.act(self.convg0(xy)))
        x0 = torch.cat([p, w0, g0], dim=1)
