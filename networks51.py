...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.resw3 = TCNBlockTranspose(ngf*4, ngf*1, 1024)
        self.convw = nn.Conv1d(ngf*1, n_wires, 1, 1, 0)

        #self.resp0 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        self.resp3 = TCNBlockTranspose(ngf*4, ngf*1, 1024)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = TCNBlock(2, ndf*2, 1024)

        self.resp0 = TCNBlock(n_features, ndf*2, 1024)
