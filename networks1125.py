...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.s1 = Simple(latent_dims, 512, 5, 4, 1, output_padding=1)
        self.s2 = Simple(512, 512, 3, 2, 1, output_padding=1)
        self.s3 = Simple(512, 256, 3, 2, 1, output_padding=1)
        self.s4 = Simple(256, 128, 3, 2, 1, output_padding=1)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.s2 = Simple(64, 128, 3, 2, 1)
        self.s3 = Simple(128, 128, 3, 2, 1)
        self.s4 = Simple(128, 128, 3, 2, 1)
        self.s5 = Simple(128, 128, 3, 2, 1)
        self.s6 = Simple(128, 128, 3, 2, 1)
        self.s7 = Simple(128, 256, 3, 2, 1)
        self.s8 = Simple(256, 512, 3, 2, 1)
        self.s9 = Simple(512, 512, 3, 2, 1)
        self.s10 = Simple(512, 512, 3, 2, 1)
