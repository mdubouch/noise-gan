...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = ResBlock(ndf, ndf*2, 513, 1, 256, seq_len)
        ...
        self.bnd1 = nn.LayerNorm((ndf*6, seq_len//2))
        self.bnd2 = nn.LayerNorm((ndf*6, seq_len//4))
        self.bnd3 = nn.LayerNorm((ndf*6, seq_len//8))
        self.bnd4 = nn.LayerNorm((ndf*6, seq_len//16))
        self.bnd5 = nn.LayerNorm((ndf*6, seq_len//32))
        self.bnd6 = nn.LayerNorm((ndf*6, seq_len//64))
        self.bn1 = nn.LayerNorm((ndf*6, seq_len//2))
        self.bn2 = nn.LayerNorm((ndf*6, seq_len//4))
        self.bn3 = nn.LayerNorm((ndf*6, seq_len//8))
        self.bn4 = nn.LayerNorm((ndf*6, seq_len//16))
        self.bn5 = nn.LayerNorm((ndf*6, seq_len//32))
        self.bn6 = nn.LayerNorm((ndf*6, seq_len//64))
