...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.conv11 = nn.Conv1d(n512//8, n512//8, 3, 1, 3, dilation=3)
        self.bn11 = nn.InstanceNorm1d(n512//8)

        self.convw2 = nn.Conv1d(n512//8, n512//8, 7, 1, 3)
        self.convw1 = nn.Conv1d(n512//8, n_wires, 1, 1, 0)

        self.convp2 = nn.Conv1d(n512//8, n512//8, 3, 1, 1)
