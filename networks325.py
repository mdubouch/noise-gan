...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(64, 32, 9, 1, 4)
        self.convw2 = nn.ConvTranspose1d(32, encoded_dim, 9, 1, 4)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.lin0 = nn.Linear(512 * seq_len // 8, 256, bias=True)
        self.lin1 = nn.Linear(256, 1, bias=True)
    ...
    def forward(self, x_): 
        ...
        w = self.act(self.convw(x[:,n_features:]))
