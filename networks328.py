...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.gb2 = GBlock(1024, 512)
        self.gb3 = GBlock(512, 512)

        self.convw1 = nn.ConvTranspose1d(512, 512, 9, 1, 4)
        self.convw2 = nn.ConvTranspose1d(512, 512, 9, 1, 4)
        self.convw3 = nn.ConvTranspose1d(512, encoded_dim, 1, 1, 0)
        self.convp = nn.ConvTranspose1d(512, n_features, 1, 1, 0)
