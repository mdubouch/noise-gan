...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.convw1 = ResBlockUp(n512, n512)
        self.convw2 = ResBlockUp(n512, n512)
        self.convw3 = ResBlockUp(n512, n512//2)
        self.convw4 = ResBlockUp(n512//2, n512//4)
        self.convw5 = ResBlockUp(n512//4, n512//8)
        self.convw6 = nn.Conv1d(n512//8, n_wires, 1, 1, 0)

        self.convp1 = ResBlockUp(n512, n512)
        self.convp2 = ResBlockUp(n512, n512)
        self.convp3 = ResBlockUp(n512, n512//2)
        self.convp4 = ResBlockUp(n512//2, n512//4)
        self.convp5 = ResBlockUp(n512//4, n512//8)
        self.convp6 = nn.Conv1d(n512//8, n_features, 1, 1, 0)
