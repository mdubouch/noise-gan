...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(ngf*8, ngf*1, 1, 1, 0)
        self.convw2 = nn.ConvTranspose1d(ngf*1, ngf*1, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convp1 = nn.Conv1d(n_features, ndf*1, 17, 8, 8) # // 8
        self.convp2 = nn.Conv1d(ndf*1, ndf*1, 1, 1, 0)

        self.convw1 = nn.Conv1d(encoded_dim, ndf*1, 17, 8, 8)
        self.convw2 = nn.Conv1d(ndf*1, ndf*1, 1, 1, 0)
        self.convw3 = nn.Conv1d(ndf*1, ndf*1, 1, 1, 0)

        self.convxy1 = nn.Conv1d(2, ndf*1, 17, 8, 8)
        self.convxy2 = nn.Conv1d(ndf*1, ndf*1, 1, 1, 0)

        self.conv1 = nn.Conv1d(ndf*2, ndf*8, 1, 1, 0)
