...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        # Common branch
        self.convu4 = ResBlockUp(n512//8)
        self.convu5 = ResBlockUp(n512//16)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw2 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convw3 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convw4 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convw5 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        ...
        self.convg2 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convg3 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convg4 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convg5 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')

        self.convp1 = nn.Conv1d(n_features, n64, 7, 1, 3, padding_mode='circular')
        self.convpd1 = nn.Conv1d(n_features, n64, 7, 1, 3, padding_mode='circular')
        self.convp2 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convp3 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convp4 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.convp5 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
    ...
    def forward(self, x_, xy_, w_): 
        ...
        pd = self.act(self.convpd1(p - self.padleft(p[:,:,:-1])))
        p = self.act(self.convp1(p))
        p = torch.cat([p, pd], dim=1)
