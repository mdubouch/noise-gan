...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convgeom1 = nn.Conv1d(n64*2, n64*3, 3, 1, 1, padding_mode='circular')
        self.convgeom2 = nn.Conv1d(n64*3, n64*4, 3, 1, 2, dilation=2, padding_mode='circular')

        self.conv1 = DBlock(n64*5, n64*6, 5, 4, 1)
        self.conv2 = DBlock(n64*6, n64*8, 5, 4, 1, dilation=2)
        self.conv3 = DBlock(n64*8, n64*9, 5, 4, 1, dilation=4)

        self.lin0 = nn.Linear(n64*9, 1)
        self.dropout = nn.Dropout(0.1)
