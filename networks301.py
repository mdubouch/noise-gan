...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.gbw1 = nn.ConvTranspose1d(512, 256, 3, 1, 1)
        self.gbw2 = nn.ConvTranspose1d(256, 128, 3, 1, 1)
        self.gbw3 = nn.ConvTranspose1d(128, 64, 3, 1, 1)
    ...
    def forward(self, z, embed_space_noise=0.0, tau=1.0):
        ...
        x = self.act(self.gbw1(x))
        x = self.act(self.gbw2(x))
        x = self.act(self.gbw3(x))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(128, 128, 3, 1, 1)
