...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.convw4 = nn.ConvTranspose1d(ngf*2, n_wires, 513, 1, 256)
        ...
        self.convp3 = nn.ConvTranspose1d(ngf*2, n_features, 513, 1, 256)
    ...
    def forward(self, z, embed_space_noise=0.0, tau=1.0):
        ...
        w4 = self.convw4(self.dropout(self.bnw3(self.act(w3))))
        w =  w4.permute(0,2,1)
        ...
        p3 = self.convp3(self.dropout(self.bnp2(self.act(p2))))
        p = p3
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.convw0 = nn.utils.spectral_norm(nn.Conv1d(2, ndf*2, 513, 1, 256, padding_mode='circular'))
        ...
        self.convp0 = nn.utils.spectral_norm(nn.Conv1d(n_features, ndf*2, 513, 1, 256, padding_mode='circular'))
