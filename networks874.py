...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(n64+n64+n64, n128, 5, 2, 0)
        self.conv2 = nn.Conv1d(n128, n256, 5, 2, 0)
        self.conv3 = nn.Conv1d(n256, n512, 5, 2, 0)
        self.conv4 = nn.Conv1d(n512, n512, 5, 2, 0)
        self.conv5 = nn.Conv1d(n512, n512, 5, 2, 0)
        self.conv6 = nn.Conv1d(n512, n512, 5, 2, 0)
        self.conv7 = nn.Conv1d(n512, n512, 5, 2, 0)
    ...
    def forward(self, x_, w_, wire_sphere): 
        ...
        x = self.conv3(self.act(x2))
        x = self.conv4(self.act(x))
        x = self.conv5(self.act(x))
        x = self.conv6(self.act(x))
        x = self.conv7(self.act(x))
