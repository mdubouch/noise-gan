...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.convuw4 = Simple(n512//4, n512//8, 3, 2, 1, output_padding=1)
        self.convuw3 = Simple(n512//8, n512//16, 3, 2, 1, output_padding=1)
        self.convw2 = Simple(n512//8, n512//16, 7, 1, 3)
        self.convw1 = nn.Conv1d(n512//16, n_wires, 1, 1, 0)

        self.convup4 = Simple(n512//4, n512//8, 3, 2, 1, output_padding=1)
        self.convup3 = Simple(n512//8, n512//16, 3, 2, 1, output_padding=1)
        self.convp2 = Simple(n512//8, n512//16, 3, 1, 1)
