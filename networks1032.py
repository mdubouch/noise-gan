...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv4 = nn.Conv1d(n64*4, n64*4, 3, 1, 27, dilation=27, padding_mode='circular')
        self.conv5 = nn.Conv1d(n64*4, n64*4, 3, 1, 81, dilation=81, padding_mode='circular')
        self.conv6 = nn.Conv1d(n64*4, n64*8, 3, 1, 27, dilation=27, padding_mode='circular')
        self.conv7 = nn.Conv1d(n64*8, n64*8, 3, 1, 9, dilation=9, padding_mode='circular')
        self.conv8 = nn.Conv1d(n64*8, n64*8, 3, 1, 3, dilation=3, padding_mode='circular')
