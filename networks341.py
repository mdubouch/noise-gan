...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.gb3 = GBlock(2048, 2048)
        self.gb4 = GBlock(2048, 2048)
        self.gb5 = GBlock(2048, 2048)
        self.gb6 = GBlock(2048, 2048)

        self.convw = nn.ConvTranspose1d(2048, n_wires, 1, 1, 0)
        self.convp = nn.ConvTranspose1d(2048, n_features, 1, 1, 0)
