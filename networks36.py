...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.tcn1 = TCNBlockTranspose(ngf*4, ngf*2, 2048)
        ...
        self.tcnw1 = TCNBlockTranspose(ngf*2, ngf*2, 2048)
        self.tcnw2 = TCNBlockTranspose(ngf*2, ngf*2, 2048)
        self.tcnw3 = TCNBlockTranspose(ngf*2, ngf, 2048)
        ...
        self.tcnp1 = TCNBlockTranspose(ngf*2, ngf*2, 2048)
        self.tcnp2 = TCNBlockTranspose(ngf*2, ngf*2, 2048)
        self.tcnp3 = TCNBlockTranspose(ngf*2, ngf, 2048)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.convw = nn.utils.spectral_norm(nn.Conv1d(2, ndf, 1, 1, 0, bias=False))
        self.tcnw1 = TCNBlock(ndf, ndf*2, 2048)
        self.tcnw2 = TCNBlock(ndf*2, ndf*2, 2048)
        self.tcnw3 = TCNBlock(ndf*2, ndf*2, 2048)

        self.convp = nn.utils.spectral_norm(nn.Conv1d(n_features, ndf, 1, 1, 0, bias=False))
        self.tcnp1 = TCNBlock(ndf, ndf*2, 2048)
        self.tcnp2 = TCNBlock(ndf*2, ndf*2, 2048)
        self.tcnp3 = TCNBlock(ndf*2, ndf*2, 2048)
        

        self.tcn1 = TCNBlock(ndf*4, ndf*6, 2048)

        self.res1 = ResBlock(ndf*6, ndf*6, 17, 1, 8, padding_mode='zeros')
