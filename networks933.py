...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        nbranch = nproj*3 + n64*2*3
        self.conv1 = nn.Conv1d(nbranch, n64*8, 3, 1, 1, padding_mode='circular')
        self.conv2 = nn.Conv1d(nbranch, n64*8, 3, 1, 2, dilation=2, padding_mode='circular')
        self.conv3 = nn.Conv1d(nbranch, n64*8, 3, 1, 4, dilation=4, padding_mode='circular')

        self.lin0 = nn.Linear(n64*8*3, 1)
        self.dropout = nn.Dropout(0.1)
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x0 = torch.cat([p0, w0, g0, p1, p2, w1, w1, g1, g2], dim=1)
        x0 = self.act(x0)
