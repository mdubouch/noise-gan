...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        n32 = n512 // 16
        n16 = n512 // 32
        self.convw1 = nn.ConvTranspose1d(n128, n64, 3, 2, 1, output_padding=1)
        self.bnw1 = nn.BatchNorm1d(n64)
        self.convw2 = nn.ConvTranspose1d(n64, n32, 3, 2, 1, output_padding=1)
        self.bnw2 = nn.BatchNorm1d(n32)
        self.convw3 = nn.ConvTranspose1d(n32, n16, 2, 2, 0)
        self.bnw3 = nn.BatchNorm1d(n16)
        self.convw4 = nn.Conv1d(n16, n_wires, 1, 1, 0, bias=False)
