...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        n512 = 128
        self.lin0 = nn.Linear(latent_dims, seq_len//256*n512, bias=True)
        ...
        self.convu4 = nn.ConvTranspose1d(n128, n128, 3, 1, 1)
        self.bnu4 = nn.BatchNorm1d(n128)
    ...
    def forward(self, z, wire_to_xy):
        ...
        x = self.act(self.bn0(self.lin0(z).view(-1, self.n512, self.seq_len // 256)))
