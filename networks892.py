...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convu3 = nn.ConvTranspose1d(n256, n128, 2, 2, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convg0 = nn.Conv1d(geom_dim, n64//4, 1, 1, 0, bias=False)
        self.convg1 = nn.Conv1d(n64//4, n64//2, 257, 1, 128, padding_mode='circular')
        self.convg2 = nn.Conv1d(n64//2, n64, 129, 1, 64, padding_mode='circular')
        ...
        class DBlock(nn.Module):
            def __init__(self, in_channels, out_channels):
                super().__init__()
                self.convd = nn.Conv1d(in_channels, out_channels, 3, 2, 0)
                self.act = nn.LeakyReLU(0.2)
        ...
        self.conv1 = nn.Conv1d(n64*3, n128, 3, 1, 0)
        self.conv2 = nn.Conv1d(n128, n128, 3, 1, 0)

        self.b1 = DBlock(n128, n128)
        self.b2 = DBlock(n128, n256)
        self.b3 = DBlock(n256, n512)
        self.b4 = DBlock(n512, n512)
        self.b5 = DBlock(n512, n512)
