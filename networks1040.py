...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv6 = nn.Conv1d(n64*16, n64*32, 3, 1, 243, dilation=243, padding_mode='circular')
        self.conv7 = nn.Conv1d(n64*32, n64*64, 3, 1, 729, dilation=729, padding_mode='circular')

        self.lin0 = nn.Linear(n64*64, 1)
