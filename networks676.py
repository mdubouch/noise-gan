...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv2 = nn.utils.spectral_norm(nn.Conv1d(n128, n256, 1, 2, 0))
        self.conv3 = nn.utils.spectral_norm(nn.Conv1d(n256, n512, 1, 2, 0))
        self.conv4 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 1, 2, 0))
        self.conv5 = nn.utils.spectral_norm(nn.Conv1d(n512, n512, 1, 2, 0))
