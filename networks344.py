...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(256, 1024, 1, 1, 0)
        self.bnw1 = nn.InstanceNorm1d(1024)
        self.convw2 = nn.ConvTranspose1d(1024, 4096, 1, 1, 0)
        self.bnw2 = nn.InstanceNorm1d(4096)
        self.convw3 = nn.ConvTranspose1d(4096, n_wires, 1, 1, 0)

        self.convp1 = nn.ConvTranspose1d(256, 64, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw = nn.Conv1d(2, 64, 1, 1, 0)
