...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convu1 = nn.ConvTranspose1d(512, 384, 4, 2, 1)
        self.bnu1 = nn.InstanceNorm1d(384)
        self.convu2 = nn.ConvTranspose1d(384, 256, 4, 2, 1)
        self.bnu2 = nn.InstanceNorm1d(256)
        self.convu3 = nn.ConvTranspose1d(256, 128, 4, 2, 1)
        self.bnu3 = nn.Identity()#nn.InstanceNorm1d(128)

        self.convp = nn.ConvTranspose1d(128, n_features, 1, 1, 0,  bias=False)
        self.convw = nn.ConvTranspose1d(128, encoded_dim, 1, 1, 0, bias=False)
