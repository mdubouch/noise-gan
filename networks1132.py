...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.s2 = Res(64, 128, 3, 1, 3, dilation=3)
        self.s6 = Res(128, 128, 3, 1, 9, dilation=9)
        self.s7 = Res(128, 256, 3, 1, 27, dilation=27)
        self.s8 = Res(256, 512, 3, 1, 81, dilation=81)
        self.s9 = Res(512, 512, 3, 1, 243, dilation=243)
