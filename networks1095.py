...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.lin0 = nn.Linear(latent_dims, 4*n128, bias=False)
        self.b1 = Simple(n128, n128, 5, 4, 1, output_padding=1)
        self.b2 = Simple(n128, n128, 5, 4, 1, output_padding=1)
        self.b3 = Simple(n128, n64, 5, 4, 1, output_padding=1)
        self.b4 = Simple(n64, n64, 5, 4, 1, output_padding=1)
        self.b5 = Simple(n64, n64, 3, 2, 1, output_padding=1)

        self.convp = nn.ConvTranspose1d(n64, n_features, 1, 1, 0, bias=True)
        self.convw = nn.ConvTranspose1d(n64, n_wires, 1, 1, 0, bias=True)
        self.out = nn.Tanh()
    ...
    def forward(self, z):
        ...
        x = self.act(self.lin0(z).reshape(-1, self.n128, 4))
...
class Disc(nn.Module):
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x = self.act(self.ln6(self.conv6(x)))
