...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(256, 256, 1, 1, 0)
        self.bnw1 = nn.InstanceNorm1d(256)
        self.convw2 = nn.ConvTranspose1d(256, 256, 1, 1, 0)
        self.bnw2 = nn.InstanceNorm1d(256)
        self.convw3 = nn.ConvTranspose1d(256, 256, 1, 1, 0)
        self.bnw3 = nn.InstanceNorm1d(256)
        self.convw4 = nn.ConvTranspose1d(256, n_wires, 1, 1, 0)

        #self.bnp0 = nn.BatchNorm1d(n_wires)
        self.convwp = nn.ConvTranspose1d(256, 32, 1, 1, 0)
    ...
    def forward(self, z, wire_to_xy):
        ...
        wf = self.act(self.bnw3(self.convw3(w)))
        w = self.convw4(wf)
