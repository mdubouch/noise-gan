...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convu1 = nn.ConvTranspose1d(ngf*8, ngf*8, 8, 4, 2)
        self.bnu1 = nn.InstanceNorm1d(ngf*8)
        self.convu2 = nn.ConvTranspose1d(ngf*8, ngf*8, 10, 4, 3)
        self.bnu2 = nn.InstanceNorm1d(ngf*8)
        self.convu3 = nn.ConvTranspose1d(ngf*8, ngf*8, 10, 4, 3)
        self.bnu3 = nn.InstanceNorm1d(ngf*8)
        self.convu4 = nn.ConvTranspose1d(ngf*8, ngf*8, 10, 4, 3)
        self.bnu4 = nn.InstanceNorm1d(ngf*8)

        self.conv7 = nn.Conv1d(ngf*8, ngf*8, 3, 1, 1)
        self.bn7 = nn.InstanceNorm1d(ngf*8)

        self.conv1 = nn.ConvTranspose1d(ngf*8, ngf*8, 3, 1, 1)
        self.conv2 = nn.ConvTranspose1d(ngf*8, ngf*1, 3, 1, 1)
        self.conv3 = nn.ConvTranspose1d(ngf*1, n_features+encoded_dim, 1, 1, 0)
