...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(nproj+geom_dim+n_features, n64, 129, 1, 64, padding_mode='circular')
        self.conv2 = nn.Conv1d(n64, n64, 65, 1, 32, padding_mode='circular')
        self.conv3 = nn.Conv1d(n64, n64, 33, 1, 16, padding_mode='circular')
        self.conv4 = nn.Conv1d(n64, n64, 17, 1, 8, padding_mode='circular')
