...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.bw3 = ResBlockDown(n64)
        self.bw4 = ResBlock(n64*2)
        ...
        self.bg3 = ResBlockDown(n64)
        self.bg4 = ResBlock(n64*2)
        ...
        self.bp3 = ResBlockDown(n64)
        self.bp4 = ResBlock(n64*2)

        # Concatenated branch
        ncat = nproj*3
        self.conv1 = nn.Conv1d(ncat, n64, 7, 1, 3, padding_mode='circular')
        self.b2 = ResBlock(n64)
        self.b3 = ResBlockDown(n64)
        self.b4 = ResBlock(n64*2)
