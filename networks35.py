...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.tcnw1 = TCNBlockTranspose(ngf*2, ngf*2, 1024)
        self.tcnw2 = TCNBlockTranspose(ngf*2, ngf*2, 1024)
        ...
        self.tcnp1 = TCNBlockTranspose(ngf*2, ngf*2, 1024)
        self.tcnp2 = TCNBlockTranspose(ngf*2, ngf*2, 1024)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.tcnw2 = TCNBlock(ndf*2, ndf*2, 1024)
        self.tcnw3 = TCNBlock(ndf*2, ndf*2, 1024)
        ...
        self.tcnp2 = TCNBlock(ndf*2, ndf*2, 1024)
        self.tcnp3 = TCNBlock(ndf*2, ndf*2, 1024)
