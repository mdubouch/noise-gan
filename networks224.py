...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv1 = nn.ConvTranspose1d(ngf*1, ngf*16, 1, 1, 0)
        self.bn1 = nn.InstanceNorm1d(ngf*16)

        self.convp = nn.Conv1d(ngf*16, n_features, 1, 1, 0)
        self.convw = nn.Conv1d(ngf*16, encoded_dim, 1, 1, 0)
