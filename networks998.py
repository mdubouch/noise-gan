...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convwd2 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
        self.convwd3 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
        ...
        self.convgd2 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
        self.convgd3 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x0 = torch.cat([p, w, wd, g, gd], dim=1)
