...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv5 = nn.Conv1d(n768, n768, 3, 2, 0)
    ...
    def forward(self, x_, w_, wire_sphere): 
        ...
        p0 = self.convp2(self.act(self.convp1(self.convp0(p))))
        w0 = self.convw2(self.act(self.convw1(self.convw0(wg))))
        g0 = self.convg2(self.act(self.convg1(self.convg0(xy))))
