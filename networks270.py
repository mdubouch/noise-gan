...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.lin0 = nn.Linear(latent_dims, seq_len//16*1024, bias=True)
        ...
        class GBlock(nn.Module):
            ...
            def forward(self, x):
                ...
                return y
        self.gb1 = GBlock(1024, 512)
        self.gb2 = GBlock(512, 256)
        self.gb3 = GBlock(256, 128)
        self.gb4 = GBlock(128, 64)
    ...
    def forward(self, z, embed_space_noise=0.0, tau=1.0):
        ...
        x = self.act(self.lin0(z).view(-1, 1024, self.seq_len // 16))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.lin0 = nn.Linear(1024 * seq_len // 16, 128, bias=True)
