...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw2 = nn.Conv1d(n512, n256, 9, 1, 4)
        self.convw1 = nn.Conv1d(n256, n_wires, 1, 1, 0)

        self.convp2 = nn.Conv1d(n512, n256, 9, 1, 4)
        self.bnp2 = nn.BatchNorm1d(n256)
        self.convp1 = nn.Conv1d(n256, n_features, 1, 1, 0)
