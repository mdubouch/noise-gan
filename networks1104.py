    ...
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        class Double(nn.Module):
            def __init__(self, in_c, out_c, *args, **kwargs):
                ...
                self.act = nn.ReLU()
            def forward(self, x):
                return self.conv2(self.norm2(self.act(self.conv(self.norm(x)))))
        ...
        self.bw1 = Double(n64, n32, 5, 4, 1, output_padding=1)
        self.bw2 = Double(n32, n16, 3, 2, 1, output_padding=1)
