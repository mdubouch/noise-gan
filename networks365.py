...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw2 = nn.ConvTranspose1d(256, n_wires, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.Conv1d(n_features+2, 256, 1, 1, 0)
        self.conv1 = nn.Conv1d(256, 128, 1, 1, 0)
        self.conv2 = nn.Conv1d(128, 96, 1, 1, 0)
        self.conv3 = nn.Conv1d(96, 64, 1, 1, 0)
        self.conv4 = nn.Conv1d(64, 64, 1, 1, 0)

        self.lin0 = nn.Linear(64 * seq_len // 1, 1, bias=True)
