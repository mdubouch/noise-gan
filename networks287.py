    ...
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        class GBlock(nn.Module):
            def __init__(self, in_channels, out_channels):
                ...
                self.conv1 = nn.ConvTranspose1d(in_channels, out_channels, 3, 1, 1)
        ...
        self.convw3 = nn.ConvTranspose1d(64, encoded_dim, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        class DBlock(nn.Module):
            def __init__(self, in_channels, out_channels):
                super().__init__()
                self.convd = nn.Conv1d(in_channels, out_channels, 3, 1, 1)
                self.act = nn.LeakyReLU(0.2)
