...
print('AE params:            {:,}'.format(networks.get_n_params(ae)))
...
print('DISTANCE BETWEEN WIRES:', torch.norm(wire_sphere[:,1] - wire_sphere[:,0]))
...
def save_states(epoch):
    states = { 'disc': disc.state_dict(), 'd_opt': optimizer_disc.state_dict(), 
            ...
            'pretrain_acc': pretrain_acc, 'validation_loss': validation_losses}
