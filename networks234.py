...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convp1 = nn.ConvTranspose1d(ngf, n_features, 1, 1, 0)
        self.convp2 = nn.ConvTranspose1d(ngf, n_features, 1, 1, 0)
        self.convw1 = nn.ConvTranspose1d(ngf, encoded_dim, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv2 = nn.Conv1d(ndf*2, ndf*2, 1, 1, 0)
        self.conv3 = nn.Conv1d(ndf*2, ndf*2, 1, 1, 0)
        
        self.lin0 = nn.Linear(ndf*2 * seq_len // 1, 1, bias=False)
