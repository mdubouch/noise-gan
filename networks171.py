...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convxy1 = nn.Conv1d(2, ndf*8, 513, 8, 256)
        self.convxy2 = nn.Conv1d(ndf*8, ndf*8, 1, 1, 0)

        self.conv1 = nn.Conv1d(ndf*20, ndf*16, 1, 1, 0)

        self.lin0 = nn.Linear(ndf*16 * seq_len // 8, 1, bias=True)
