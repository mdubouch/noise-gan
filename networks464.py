...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw = nn.Conv1d(n_wires, 256, 1, 1, 0, bias=False)
        self.conv1 = nn.Conv1d(256+0, 384, 1, 1, 0)
        self.conv2 = nn.Conv1d(384, 512, 9, 1, 4)
        self.conv3 = nn.Conv1d(512, 768, 9, 1, 4)
        self.db1 = DBlock(768, 1024)
