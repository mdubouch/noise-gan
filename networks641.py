...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.Conv1d(geom_dim*1, n192, 1, 1, 0)

        n256 = n64 * 4
        self.conv1 = nn.Conv1d(n192, n256, 3, 1, 1)

        n512 = n256 * 2
        self.conv2 = nn.Conv1d(n256, n512, 3, 1, 1)
        self.conv3 = nn.Conv1d(n512, n512, 3, 1, 1)
        self.conv4 = nn.Conv1d(n512, n512, 3, 1, 1)
        self.conv5 = nn.Conv1d(n512, n512, 3, 1, 1)
