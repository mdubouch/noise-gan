...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv7 = nn.Conv1d(ngf*8, ngf*8, 33, 1, 16)
        self.bn7 = nn.InstanceNorm1d(ngf*8)

        self.conv1 = nn.ConvTranspose1d(ngf*8, ngf*4, 33, 1, 16)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convp = nn.Conv1d(n_features, ndf*4, 33, 1, 16)
        self.convw = nn.Conv1d(encoded_dim, ndf*4, 33, 1, 16)
        self.conv2 = nn.Conv1d(ndf*8, ndf*8, 33, 1, 16)
