...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.bnd1 = nn.InstanceNorm1d(ndf*6)
        self.bnd2 = nn.InstanceNorm1d(ndf*6)
        self.bnd3 = nn.InstanceNorm1d(ndf*6)
        self.bnd4 = nn.InstanceNorm1d(ndf*6)
        self.bnd5 = nn.InstanceNorm1d(ndf*6)
        self.bnd6 = nn.InstanceNorm1d(ndf*6)
        self.bn1 = nn.InstanceNorm1d(ndf*6)
        self.bn2 = nn.InstanceNorm1d(ndf*6)
        self.bn3 = nn.InstanceNorm1d(ndf*6)
        self.bn4 = nn.InstanceNorm1d(ndf*6)
        self.bn5 = nn.InstanceNorm1d(ndf*6)
        self.bn6 = nn.InstanceNorm1d(ndf*6)
