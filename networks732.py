...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv2 = nn.Conv1d(n64*1+n128, n256, 3, 2, 1)
        self.conv3 = nn.Conv1d(n256, n512, 3, 2, 1)
        self.conv4 = nn.Conv1d(n256+n512, n512, 3, 2, 1)
        self.conv5 = nn.Conv1d(n512, n512, 3, 2, 1)
        self.conv6 = nn.Conv1d(n512+n512, n512, 3, 2, 0)
