...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(64, 256, 3, 1, 1)
        self.bnw1 = nn.InstanceNorm1d(256)
        self.convw2 = nn.ConvTranspose1d(256, 512, 3, 1, 1)
        self.bnw2 = nn.InstanceNorm1d(512)
        self.convw3 = nn.ConvTranspose1d(512, n_wires, 1, 1, 0)
