...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        n64 = n512 // 8
        self.conv1 = nn.Conv1d(n512, n64, 1, 1, 0)
    ...
    def forward(self, z, wire_to_xy):
        ...
        x = self.act(self.bn0(self.lin0(z).view(-1, self.n512, self.seq_len // 1)))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convf = nn.Conv1d(n192, 1, 3, 1, 1, padding_mode='circular')
