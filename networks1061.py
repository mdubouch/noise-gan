...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.convu1 = Simple(n512, n512, 3, 2, 1, output_padding=1)
        self.convu2 = Simple(n512, n512//2, 3, 2, 1, output_padding=1)
        ...
        self.convp2 = Simple(n512//16, n512//16, 3, 1, 1)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv1 = nn.Conv1d(nproj+geom_dim+n_features, n512//2, 7, 1, 3, padding_mode='circular')
        self.conv2 = nn.Conv1d(n512//2, n512//2, 3, 1, 1, dilation=4, padding_mode='circular')
        self.conv3 = nn.Conv1d(n512//2, n512//2, 3, 1, 1, dilation=16, padding_mode='circular')
        self.conv4 = nn.Conv1d(n512//2, n512, 3, 1, 1, dilation=64, padding_mode='circular')
        self.conv5 = nn.Conv1d(n512,    n512, 3, 1, 1, dilation=256, padding_mode='circular')
