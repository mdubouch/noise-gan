...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        # Common branch
        ncom = n256*3 + ncat*8
        self.convc1 = DBlock(ncom, ncom, 3, 2, 1, padding_mode='circular')
        self.convc2 = DBlock(ncom, ncom, 3, 2, 1, padding_mode='circular')
        self.convc3 = DBlock(ncom, ncom, 3, 2, 1, padding_mode='circular')
