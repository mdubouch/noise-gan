...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convp2 = nn.Conv1d(ndf, ndf*1, 1, 1, 0)
        self.convw1 = nn.Conv1d(encoded_dim, ndf*1, 1, 1, 0)
        self.convw2 = nn.Conv1d(ndf, ndf*1, 1, 1, 0)
        self.conv2 = nn.Conv1d(ndf*1, ndf*1, 4, 2, 1)
        self.conv3 = nn.Conv1d(ndf*1, ndf*1, 4, 2, 1)
        self.conv4 = nn.Conv1d(ndf*1, ndf*1, 4, 2, 1)
        
        self.lin0 = nn.Linear(ndf*1 * seq_len // 8, 1, bias=False)
