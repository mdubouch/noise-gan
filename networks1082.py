...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.convl1 = Simple(n512, n512//2, 5, 4, 1, output_padding=1)
        self.convl2 = Simple(n512//2, n512//4, 5, 4, 1, output_padding=1)
        self.convl3 = Simple(n512//4, n512//8, 5, 4, 1, output_padding=1)
        self.convp = nn.ConvTranspose1d(n512//8, n_features, 1, 1, 0, bias=False)
        self.convw = nn.ConvTranspose1d(n512//8, n_wires, 1, 1, 0, bias=False)
        self.out = nn.Tanh()
