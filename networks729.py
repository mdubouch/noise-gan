...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw0 = nn.Conv1d(geom_dim, 1024, 1, 1, 0)
        self.convw1 = nn.Conv1d(1024, 512, 1, 1, 0)
        self.convw2 = nn.Conv1d(512, n64, 1, 1, 0)

        self.conv1 = nn.Conv1d(n64, n128, 4, 2, 0)

        self.conv2 = nn.Conv1d(n64+n128, n256, 8, 2, 0)
        self.conv3 = nn.Conv1d(n256, n512, 8, 4, 0)
        self.conv4 = nn.Conv1d(n256+n512, n512, 8, 4, 0)
        self.conv5 = nn.Conv1d(n512, n512, 4, 2, 0)
        self.conv6 = nn.Conv1d(n512+n512, n512, 4, 2, 0)
