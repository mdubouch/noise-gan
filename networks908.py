...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw1 = nn.Conv1d(n64, n64, 17, 1, 8, padding_mode='circular')
        self.convg1 = nn.Conv1d(n64, n64, 17, 1, 8, padding_mode='circular')

        self.conv1 = nn.Conv1d(n64*5, n128, 9, 1, 4, padding_mode='circular')
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x0 = torch.cat([p0, w0, w1, g0, g1], dim=1)
