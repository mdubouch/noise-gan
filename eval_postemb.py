...
print('Evaluating with networks version %s' % (args.net_version))
# Initialize networks
...
plt.hist(real_dist, bins=150, alpha=0.7, density=True)
plt.hist(fake_dist, bins=150, alpha=0.7, density=True)
...
print('Eval of job %d at epoch %d with networks %s done.' % (args.job_id, args.epoch, args.net_version))
