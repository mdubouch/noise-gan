...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.linw1 = nn.Linear(512, n_wires)

        #self.bnp0 = nn.BatchNorm1d(n_wires)
        self.convxp = nn.ConvTranspose1d(512, 256, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convpxy = nn.Conv1d(n_features+2, 256, 1, 1, 0)
        self.conv1 = nn.Conv1d(256, 512, 9, 1, 4)
