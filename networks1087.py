...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv1 = nn.Conv1d(nproj+geom_dim+n_features, n16, 3, 2, 1, padding_mode='circular')
        self.conv2 = nn.Conv1d(n16, n32, 5, 4, 1)
        self.conv3 = nn.Conv1d(n32, n64, 5, 4, 1)
        self.conv4 = nn.Conv1d(n64, n128, 5, 4, 1)
        self.conv5 = nn.Conv1d(n128, n256, 5, 4, 1)
        self.conv6 = nn.Conv1d(n256, n512, 5, 4, 1)
