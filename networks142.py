...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(ngf*6, ngf*6, 1, 1, 0)
        self.conv2 = nn.Conv1d(ngf*6, ngf*6, 1, 1, 0)
        self.conv3 = nn.Conv1d(ngf*6, ngf*6, 1, 1, 0)
        self.conv4 = nn.Conv1d(ngf*6, ngf*4, 1, 1, 0)
        ...
        self.conv7 = nn.Conv1d(ngf*4, ngf*3, 1, 1, 0)
        self.bn7 = nn.InstanceNorm1d(ngf*3)
        self.conv8 = nn.ConvTranspose1d(ngf*3, ngf*3, 1, 1, 0)
