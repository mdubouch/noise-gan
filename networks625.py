...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.Conv1d(n64, n64, 17, 1, 8)
        self.bnw1 = nn.BatchNorm1d(n64)
        self.convw2 = nn.Conv1d(n64, n64, 17, 1, 8)
        self.bnw2 = nn.BatchNorm1d(n64)
        self.convw3 = nn.Conv1d(n64, n64, 17, 1, 8)
        self.bnw3 = nn.BatchNorm1d(n64)
        self.convw4 = nn.Conv1d(n64, n64, 17, 1, 8)
        self.bnw4 = nn.BatchNorm1d(n64)
        self.convw5 = nn.Conv1d(n64, n_wires, 1, 1, 0, bias=False)
