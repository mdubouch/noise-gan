...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.linw3 = nn.Linear(n512, n128)
        self.linw2 = nn.Linear(n128, 4)
        self.linw1 = nn.Linear(4, n_wires)
    ...
    def forward(self, z, wire_to_xy):
        ...
        w = self.act(self.linw3(w.permute(0,2,1)))
        w = self.act(self.linw2(w))
        w = self.linw1(w).permute(0,2,1)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(n64, n128, 17, 1, 8, padding_mode='circular')
        self.conv2 = nn.Conv1d(n128, n256, 9, 1, 4, padding_mode='circular')
        self.conv3 = nn.Conv1d(n256, n512, 5, 1, 2, padding_mode='circular')
