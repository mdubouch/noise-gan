...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv3 = nn.Conv1d(n64*2, n64*3, 3, 1, 9, dilation=9, padding_mode='circular')
        self.conv4 = nn.Conv1d(n64*3, n64*4, 3, 1, 27, dilation=27, padding_mode='circular')
        self.conv5 = nn.Conv1d(n64*4, n64*5, 3, 1, 81, dilation=81, padding_mode='circular')
        self.conv6 = nn.Conv1d(n64*5, n64*6, 3, 1, 243, dilation=243, padding_mode='circular')
        self.conv7 = nn.Conv1d(n64*6, n64*7, 3, 1, 729, dilation=729, padding_mode='circular')

        self.lin0 = nn.Linear(n64*7, 1)
