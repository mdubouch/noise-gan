...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convp1 = nn.ConvTranspose1d(2, 64, 1, 1, 0)
        self.bnp1 = nn.InstanceNorm1d(128)
        self.convp2 = nn.ConvTranspose1d(128, 64, 1, 1, 0)
    ...
    def forward(self, z, wire_to_xy):
        ...
        p = self.act(self.bnp1(torch.cat([self.convxp(x), self.convp1(xy)], dim=1)))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(64, 128, 5, 1, 2)
