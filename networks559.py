...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        n192 = n64 * 3
        self.conv1 = nn.utils.spectral_norm(nn.Conv1d(n192, n192, 9, 1, 4))
        self.conv2 = nn.utils.spectral_norm(nn.Conv1d(n192, n192, 9, 1, 4))
        self.conv3 = nn.utils.spectral_norm(nn.Conv1d(n192, n192, 9, 1, 4))
