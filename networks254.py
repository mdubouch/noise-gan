...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv2 = nn.Conv1d(1024, 1024, 4, 2, 1)
        self.conv3 = nn.Conv1d(1024, 1024, 4, 2, 1)
        self.conv4 = nn.Conv1d(1024, 1024, 4, 2, 1)
        
        self.lin0 = nn.Linear(1024 * seq_len // 8, 1, bias=True)
