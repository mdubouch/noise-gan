...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        n512 = 512
        self.linw = nn.Linear(latent_dims, seq_len//32*n512, bias=False)
        self.linp = nn.Linear(latent_dims, seq_len//32*n512, bias=False)
        ...
        # W branch
        self.convuw1 = ResBlockUp(n512//1)
        self.convuw2 = ResBlockUp(n512//2)
        self.convuw3 = ResBlockUp(n512//4)
        self.convuw4 = ResBlockUp(n512//8)
        self.convuw5 = ResBlockUp(n512//16)

        # P branch
        self.convup1 = ResBlockUp(n512//1)
        self.convup2 = ResBlockUp(n512//2)
        self.convup3 = ResBlockUp(n512//4)
        self.convup4 = ResBlockUp(n512//8)
        self.convup5 = ResBlockUp(n512//16)
    ...
    def forward(self, z):
        ...
        w = self.act(self.linw(z).reshape(-1, self.n512, self.seq_len // 32))
        p = self.act(self.linp(z).reshape(-1, self.n512, self.seq_len // 32))
