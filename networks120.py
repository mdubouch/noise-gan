...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.conv8 = nn.Conv1d(ngf*3, ngf*2, 9, 1, 4)
        self.bn8 = nn.InstanceNorm1d(ngf*2)
        self.conv9 = nn.Conv1d(ngf*2, ngf*1, 9, 1, 4)
        self.bn9 = nn.InstanceNorm1d(ngf*1)
        self.conv10 = nn.ConvTranspose1d(ngf, ngf, 513, 1, 256)

        self.conv11 = nn.Conv1d(ngf, n_features+encoded_dim, 1, 1, 0)
