...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw6 = GBlock(n512, n512, 4, 4, 0)
        self.convw5 = GBlock(n512, n512, 4, 4, 0)
        self.convw4 = GBlock(n512, n256, 4, 2, 1)
        self.convw3 = GBlock(n256, n128, 4, 2, 1)
        ...
        self.convp6 = GBlock(n512, n512, 4, 4, 0)
        self.convp5 = GBlock(n512, n512, 4, 4, 0)
        self.convp4 = GBlock(n512, n256, 4, 2, 1)
        self.convp3 = GBlock(n256, n128, 4, 2, 1)
    ...
    def forward(self, z, wire_to_xy):
        ...
        x = self.act(self.lin0(z).reshape(-1, self.n512, self.seq_len // 64))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(n64*2, n128, 3, 2, 0)
        self.conv2 = nn.Conv1d(n64*2+n128, n256, 3, 2, 0)
        self.conv3 = nn.Conv1d(n256, n512, 3, 2, 0)
        self.conv4 = nn.Conv1d(n256+n512, n512, 3, 2, 0)
        self.conv5 = nn.Conv1d(n512, n512, 3, 4, 0)
        self.conv6 = nn.Conv1d(n512+n512, n512, 3, 4, 0)
