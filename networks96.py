...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.tcn2 = TCNBlockTranspose(ngf*1, ngf, 512)
        self.convw3 = nn.Conv1d(ngf, encoded_dim, 1, 1, 0, bias=False)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.tcn1 = TCNBlock(ndf, ndf*1, 512)
