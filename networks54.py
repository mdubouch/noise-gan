...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.convw1 = nn.Conv1d(ngf*2, ngf*2, 17, 1, 32, dilation=4)
        self.convw2 = nn.Conv1d(ngf*2, ngf*1, 17, 1, 16, dilation=2)
        self.convw3 = nn.Conv1d(ngf*1, ngf*1, 17, 1, 8)
        ...
        self.convp1 = nn.Conv1d(ngf*2, ngf*2, 17, 1, 32, dilation=4)
        self.convp2 = nn.Conv1d(ngf*2, ngf*1, 17, 1, 16, dilation=2)
        self.convp3 = nn.Conv1d(ngf*1, ngf*1, 17, 1, 8)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.convw2 = nn.Conv1d(ndf*1, ndf*1, 17, 1, 8, dilation=1)
        self.convw3 = nn.Conv1d(ndf*1, ndf*2, 17, 1, 16, dilation=2)
        self.convw4 = nn.Conv1d(ndf*2, ndf*2, 17, 1, 32, dilation=4)
        self.resw0 = TCNBlock(ndf*2, ndf*2, 1024)

        self.convp1 = nn.Conv1d(n_features, ndf*1, 17, 1, 8)
        self.convp2 = nn.Conv1d(ndf*1, ndf*1, 17, 1, 8, dilation=1)
        self.convp3 = nn.Conv1d(ndf*1, ndf*2, 17, 1, 16, dilation=2)
        self.convp4 = nn.Conv1d(ndf*2, ndf*2, 17, 1, 32, dilation=4)
        self.resp0 = TCNBlock(ndf*2, ndf*2, 1024)
