...
wire_to_rth[0] = wire_to_r_norm
wire_to_rth[1] = torch.atan2(wire_to_xy[1], wire_to_xy[0])
...
for e in range(start_epoch, start_epoch + n_epochs):
    ...
    for i, (real_p, real_w) in enumerate(train_loader):
        ...
        real_xy = wire_to_rth[:,real_w].squeeze().permute(1, 0, 2)
        ...
        fake_xy = torch.tensordot(fake_wg, wire_to_rth, dims=[[1], [1]]).permute(0,2,1)
