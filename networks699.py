...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw2 = nn.ConvTranspose1d(n64, n64, 3, 1, 1)
        self.convw3 = nn.ConvTranspose1d(n64, n_wires, 1, 1, 0, bias=True)

        self.convp1 = nn.ConvTranspose1d(n64, n64, 64, 2, 31)
        self.bnp1 = nn.BatchNorm1d(n64)
        self.convp2 = nn.ConvTranspose1d(n64, n64, 3, 1, 1)
        self.convp3 = nn.ConvTranspose1d(n64, n_features, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0i = nn.utils.spectral_norm(nn.Conv1d(n_features, n64, 256, 1, 0))
        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(n64, n64, 3, 2, 0))
        ...
        self.conv4 = nn.utils.spectral_norm(nn.Conv1d(n256+n512, n512, 3, 2, 0))
