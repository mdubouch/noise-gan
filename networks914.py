...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convgeom1 = DBlock(n64*4, n64*5, 3, 1, 1, padding_mode='circular')
        self.convgeom2 = DBlock(n64*5, n64*6, 3, 1, 2, dilation=2, padding_mode='circular')

        self.conv1 = DBlock(n64*8, n64*12, 5, 4, 1, padding_mode='circular')
