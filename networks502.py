...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.Conv1d(128, 128, 1, 1, 0)
        self.bnw1 = nn.BatchNorm1d(128)
        self.convw2 = nn.Conv1d(128, 128, 1, 1, 0)
        self.bnw2 = nn.BatchNorm1d(128)
        self.convw3 = nn.Conv1d(128, n_wires, 1, 1, 0, bias=False)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw = nn.Conv1d(n_wires, 128, 1, 1, 0, bias=False)
        self.conv1 = nn.Conv1d(128*2, 192, 17, 1, 8)
    ...
    def forward(self, x_): 
        ...
        w = self.convw(wg + torch.randn_like(wg) * 0.1)
