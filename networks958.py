...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        # Common branch
        self.convu4 = GBlock(n512, n512, 3, 2, 1, output_padding=1)
        self.convu5 = GBlock(n512, n256, 3, 2, 1, output_padding=1)
        self.convu6 = GBlock(n256, n128, 3, 2, 1, output_padding=1)

        # W branch
        self.convuw1 = GBlock(n512, n512, 3, 2, 1, output_padding=1)
        self.convuw2 = GBlock(n512, n256, 3, 2, 1, output_padding=1)
        self.convuw3 = GBlock(n256, n128, 3, 2, 1, output_padding=1)

        # P branch
        self.convup1 = GBlock(n512, n512, 3, 2, 1, output_padding=1)
        self.convup2 = GBlock(n512, n256, 3, 2, 1, output_padding=1)
        self.convup3 = GBlock(n256, n128, 3, 2, 1, output_padding=1)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw2 = nn.Conv1d(n64, n128, 3, 2, 1, padding_mode='circular')
        self.convw3 = nn.Conv1d(n128, n256, 3, 2, 1, padding_mode='circular')
        self.convw4 = nn.Conv1d(n256, n256, 3, 2, 1, padding_mode='circular')
        self.convw5 = nn.Conv1d(n256, n256, 3, 2, 1, padding_mode='circular')

        self.convg0 = nn.Conv1d(geom_dim, nproj, 1, 1, 0)
        self.convg1 = nn.Conv1d(nproj, n64, 3, 1, 1, padding_mode='circular')
        self.convg2 = nn.Conv1d(n64, n128, 3, 2, 1, padding_mode='circular')
        self.convg3 = nn.Conv1d(n128, n256, 3, 2, 1, padding_mode='circular')
        self.convg4 = nn.Conv1d(n256, n256, 3, 2, 1, padding_mode='circular')
        self.convg5 = nn.Conv1d(n256, n256, 3, 2, 1, padding_mode='circular')

        self.convp0 = nn.Conv1d(n_features, nproj, 1, 1, 0)
        self.convp1 = nn.Conv1d(nproj, n64, 3, 1, 1, padding_mode='circular')
        self.convp2 = nn.Conv1d(n64, n128, 3, 2, 1, padding_mode='circular')
        self.convp3 = nn.Conv1d(n128, n256, 3, 2, 1, padding_mode='circular')
        self.convp4 = nn.Conv1d(n256, n256, 3, 2, 1, padding_mode='circular')
        self.convp5 = nn.Conv1d(n256, n256, 3, 2, 1, padding_mode='circular')

        # Concatenated branch
        ncat = nproj*3
        self.conv1 = nn.Conv1d(ncat, ncat*2, 3, 1, 1, padding_mode='circular')
        self.conv2 = nn.Conv1d(ncat*2, ncat*4, 3, 2, 1, padding_mode='circular')
        self.conv3 = nn.Conv1d(ncat*4, ncat*8, 3, 2, 1, padding_mode='circular')
        self.conv4 = nn.Conv1d(ncat*8, ncat*8, 3, 2, 1, padding_mode='circular')
        self.conv5 = nn.Conv1d(ncat*8, ncat*8, 3, 2, 1, padding_mode='circular')

        # Common branch

        self.lin0 = nn.Linear(n256*3 + ncat*8, 1)
        self.dropout = nn.Dropout(0.1)
    ...
    def forward(self, x_, xy_, w_): 
        ...
        cat = self.act(self.conv4(cat))
        cat = self.act(self.conv5(cat))
