...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.tcn7 = TCNBlockTranspose(ngf*4, ngf*2, 1024)

        #self.resw0 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        self.resw1 = TCNBlockTranspose(ngf*2, ngf*2, 1024)
        self.resw2 = TCNBlockTranspose(ngf*2, ngf*1, 1024)
        self.resw3 = TCNBlockTranspose(ngf*1, ngf*1, 1024)
        self.convw = nn.Conv1d(ngf*1, n_wires, 1, 1, 0)

        #self.resp0 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        self.resp1 = TCNBlockTranspose(ngf*2, ngf*2, 1024)
        self.resp2 = TCNBlockTranspose(ngf*2, ngf*1, 1024)
        self.resp3 = TCNBlockTranspose(ngf*1, ngf*1, 1024)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = TCNBlock(ndf*1, ndf*1, 1024)
        self.resw1 = TCNBlock(ndf*1, ndf*2, 1024)
        self.resw2 = TCNBlock(ndf*2, ndf*2, 1024)

        self.convp = nn.Conv1d(n_features, ndf*1, 1, 1, 0)
        self.resp0 = TCNBlock(ndf*1, ndf*1, 1024)
        self.resp1 = TCNBlock(ndf*1, ndf*2, 1024)
        self.resp2 = TCNBlock(ndf*2, ndf*2, 1024)
        

        self.res1 = TCNBlock(ndf*4, ndf*6, 1024)
        self.res2 = TCNBlock(ndf*6, ndf*6, 1024)
        self.res3 = TCNBlock(ndf*6, ndf*6, 1024)
        self.res4 = TCNBlock(ndf*6, ndf*6, 1024)
        self.res5 = TCNBlock(ndf*6, ndf*6, 1024)
