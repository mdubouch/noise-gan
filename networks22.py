...
class TCNBlock(nn.Module):
    def __init__(self, in_channels, out_channels, receptive_field_size):
        ...
        for i in range(self.n_convs):
            ...
            self.pads.append(nn.ReplicationPad1d((dilation, 0)))
            print(self.convs[i])
...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.tcn1 = TCNBlockTranspose(ngf*4, ngf*4, 64)
        self.tcn2 = TCNBlockTranspose(ngf*4, ngf*4, 128)
        self.tcn3 = TCNBlockTranspose(ngf*4, ngf*2, 1024)
        ...
        self.resw3 = ResBlockTranspose(ngf*2, n_wires, 1, 1, 0)
        ...
        self.resp3 = ResBlockTranspose(ngf*2, n_features, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = ResBlock(n_wires, ndf*2, 1, 1, 0, padding_mode='circular')
        ...
        self.resp0 = ResBlock(n_features, ndf*2, 1, 1, 0, padding_mode='circular')
        ...
        self.tcn1 = TCNBlock(ndf*4, ndf*4, 1024)
        self.tcn2 = TCNBlock(ndf*4, ndf*4, 128)
        self.tcn3 = TCNBlock(ndf*4, ndf*6, 64)
