...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv1 = nn.Conv1d(nproj+geom_dim+n_features, 16, 3, 1, 1, padding_mode='circular')
        self.conv2 = nn.Conv1d(16, 32, 3, 2, 1)
        self.conv3 = nn.Conv1d(32, 64, 5, 4, 1)
        self.conv4 = nn.Conv1d(64, 128, 5, 4, 1)
        self.conv5 = nn.Conv1d(128, 256, 5, 4, 1)
