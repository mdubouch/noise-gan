...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.bn1 = nn.Identity()#nn.InstanceNorm1d(ngf*6)
        self.bn2 = nn.Identity()#nn.InstanceNorm1d(ngf*6)
        self.bn3 = nn.Identity()#nn.InstanceNorm1d(ngf*6)
        self.bn4 = nn.Identity()#nn.InstanceNorm1d(ngf*6)
        self.bn5 = nn.Identity()#nn.InstanceNorm1d(ngf*6)
        self.bn6 = nn.Identity()#nn.InstanceNorm1d(ngf*6)
