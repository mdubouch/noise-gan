...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv3 = nn.Conv1d(n64, n64*2, 3, 2, 1, padding_mode='circular')
        self.conv4 = nn.Conv1d(n64*2, n64*2, 3, 1, 1, padding_mode='circular')
        self.conv5 = nn.Conv1d(n64*2, n64*4, 3, 2, 1, padding_mode='circular')
        self.conv6 = nn.Conv1d(n64*4, n64*4, 3, 1, 1, padding_mode='circular')
        self.conv7 = nn.Conv1d(n64*4, n64*8, 3, 2, 1, padding_mode='circular')
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x = self.lin0(self.dropout(x.mean(2))).squeeze()
