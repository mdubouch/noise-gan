...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw2 = nn.ConvTranspose1d(ngf*8, encoded_dim, 257, 1, 128)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convp2 = nn.Conv1d(ndf*8, ndf*4, 1, 1, 0)

        self.convw_diff1 = nn.Conv1d(encoded_dim, ndf*4, 257, 1, 128)
        self.convw1 = nn.Conv1d(encoded_dim, ndf*4, 257, 1, 128)
        self.convw2 = nn.Conv1d(ndf*8, ndf*4, 1, 1, 0)
    ...
    def forward(self, x_): 
        ...
        w = self.act(torch.cat([self.convw1(w), w_diff], dim=1))
