...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convp = nn.ConvTranspose1d(encoded_dim, n_features, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.dbw1 = DBlock(128, 64)
        self.dbw2 = DBlock(64, 64)
        self.dbw3 = DBlock(64, 64)

        self.db1 = DBlock(64, 64)
        self.db2 = DBlock(64, 64)
        self.db3 = DBlock(64, 64)
        
        self.lin0 = nn.Linear(64 * seq_len // 64, 64, bias=True)
        self.lin1 = nn.Linear(64, 1, bias=True)
