...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(n64, n256, 9, 1, 4)
        self.bn1 = nn.Identity()#nn.InstanceNorm1d(n256)
        self.conv2 = nn.Conv1d(n256, n128, 8, 4, 2)
        self.bn2 = nn.Identity()#nn.InstanceNorm1d(n128)
        self.conv3 = nn.Conv1d(n128, n64, 4, 4, 0)
        self.bn3 = nn.Identity()#nn.InstanceNorm1d(n64)
