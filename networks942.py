...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        # Common branch
        self.convc1 = nn.Conv1d(n64*4*3 + ncat*8, n64*24, 3, 2, 1, padding_mode='circular')
        self.lin0 = nn.Linear(n64*24, 1)
        self.dropout = nn.Dropout(0.1)
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x = self.act(self.convc1(self.dropout(x)))
