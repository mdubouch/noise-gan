...
wire_sphere = wire_sphere / (1e-8 + wire_sphere.std(dim=1, keepdim=True)) * data_std
...
wire_sphere_norm = wire_sphere.norm(dim=0)
def wire_hook(grad):
    return grad / wire_sphere_norm.view(1, -1, 1)
