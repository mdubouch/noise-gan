...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv2 = nn.Conv1d(n512//8, n512//4, 3, 2, 1, dilation=1, padding_mode='circular')
        self.conv3 = nn.Conv1d(n512//4, n512//2, 3, 2, 1, dilation=1, padding_mode='circular')
        self.conv4 = nn.Conv1d(n512//2, n512, 3, 2, 1, dilation=1, padding_mode='circular')
        self.conv5 = nn.Conv1d(n512,    n512, 3, 1, 1, dilation=1, padding_mode='circular')
