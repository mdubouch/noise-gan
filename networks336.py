...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convw1 = nn.ConvTranspose1d(64, 256, 9, 1, 4)
        self.convw2 = nn.ConvTranspose1d(256, 512, 1, 1, 0)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convp = nn.Conv1d(2, 64, 1, 1, 0)
        self.convp2 = nn.Conv1d(64, 64, 1, 1, 0)
    ...
    def forward(self, x_): 
        ...
        x = self.act(self.convp(x[:,n_features:]))
