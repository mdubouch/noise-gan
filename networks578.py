...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.wemb = nn.Conv1d(n64, emb_dim, 3, 1, 1)
        self.convw = nn.Conv1d(emb_dim, n_wires, 1, 1, 0, bias=False)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(emb_dim + n_features+geom_dim, n192, 3, 1, 1))
