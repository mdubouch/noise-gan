...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        class GBlock(nn.Module):
            ...
            def forward(self, x):
                ...
                x0 = F.interpolate(x, size=y.shape[2])
        ...
        self.convp6 = GBlock(n512, n512, 12, 2, 5)
        self.convp5 = GBlock(n512, n512, 12, 2, 5)
        self.convp4 = GBlock(n512, n256, 12, 2, 5)
        self.convp3 = GBlock(n256, n128, 12, 2, 5)
    ...
    def forward(self, z, wire_to_xy):
        ...
        x = self.bn0(self.lin0(z).reshape(-1, self.n512, self.seq_len // 16))
        ...
        w = self.act(self.bnw3(self.convw3(self.act(x))))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.utils.spectral_norm(nn.Conv1d(n_features, n64, 3, 1, 0))
