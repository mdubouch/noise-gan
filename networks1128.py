...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.s1 = Simple(n_features+nproj+geom_dim, 64, 129, 1, 64, padding_mode='circular')
        ...
        self.s8 = Simple(256, 256, 3, 2, 1)
        self.s9 = Simple(256, 256, 3, 2, 1)
        self.s10 = Simple(256, 256, 3, 2, 1)
