...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convp1 = nn.ConvTranspose1d(ngf*8, ngf, 1, 1, 0)
        self.convp2 = nn.ConvTranspose1d(ngf*1, ngf, 1, 1, 0)
        self.convp3 = nn.ConvTranspose1d(ngf, n_features, 257, 1, 128)

        self.convw1 = nn.ConvTranspose1d(ngf*8, ngf*4, 1, 1, 0)
        self.convw2 = nn.ConvTranspose1d(ngf*4, ngf*2, 1, 1, 0)
        self.convw3 = nn.ConvTranspose1d(ngf*2, encoded_dim, 257, 1, 128)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convp3 = nn.Conv1d(ndf, ndf*8, 1, 1, 0)
        #self.convw_diff1 = nn.Conv1d(encoded_dim, ndf*2, 1, 1, 0)
        self.convw1 = nn.Conv1d(encoded_dim, ndf*2, 257, 1, 128)
        self.convw2 = nn.Conv1d(ndf*2, ndf*4, 1, 1, 0)
        self.convw3 = nn.Conv1d(ndf*4, ndf*8, 1, 1, 0)

        self.conv1 = nn.Conv1d(ndf*16, ndf*8, 1, 1, 0)
