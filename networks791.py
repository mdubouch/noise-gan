...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.Conv1d(geom_dim, geom_dim, 1, 1, 0)
        self.conv1 = nn.Conv1d(geom_dim, n64, 1, 1, 0)
        self.bn1 = nn.InstanceNorm1d(n64, affine=True)
    ...
    def forward(self, x_, w_, wire_sphere): 
        ...
        x = self.conv0(x)
        x = self.act(self.bn1(self.conv1(x))).permute(0,2,1)
