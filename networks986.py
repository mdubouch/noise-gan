...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim):
        ...
        self.convr1 = ResBlock(n512)
        self.convu1 = ResBlockUp(n512)
        self.convr2 = ResBlock(n512//2)
        self.convu2 = ResBlockUp(n512//2)
        self.convr3 = ResBlock(n512//4)
        self.convu3 = ResBlockUp(n512//4)

        # W branch
        self.bw1 = ResBlock(n512//8)
        self.buw1 = ResBlockUp(n512//8)
        self.bw2 = ResBlock(n512//16)
        self.buw2 = ResBlockUp(n512//16)
        self.bw3 = ResBlock(n512//32)
        self.convw2 = nn.Conv1d(n512//32, n512//32, 7, 1, 3)
        self.convw1 = nn.Conv1d(n512//32, n_wires, 1, 1, 0)

        # P branch
        self.bp1 = ResBlock(n512//8)
        self.bup1 = ResBlockUp(n512//8)
        self.bp2 = ResBlock(n512//16)
        self.bup2 = ResBlockUp(n512//16)
        self.bp3 = ResBlock(n512//32)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.convw1 = nn.Conv1d(nproj, n64, 129, 1, 64, padding_mode='circular')
        self.convw2 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
        self.convw3 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')

        self.convg1 = nn.Conv1d(geom_dim, n64, 129, 1, 64, padding_mode='circular')
        self.convg2 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
        self.convg3 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')

        self.convp1 = nn.Conv1d(n_features, n64, 129, 1, 64, padding_mode='circular')
        self.convp2 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
        self.convp3 = nn.Conv1d(n64, n64, 3, 1, 1, padding_mode='circular')
    ...
    def forward(self, x_, xy_, w_): 
        ...
        p = self.act(self.convp1(self.dropout(p)))
        ...
        g = self.act(self.convg1(self.dropout(xy)))
        g = self.act(self.convg2(g))
        g = self.act(self.convg3(g))

        x = torch.cat([p, w, g], dim=1)
