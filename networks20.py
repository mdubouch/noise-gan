...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.res7 = ResBlockTranspose(ngf*4, ngf*2, 17, 1, 8)

        #self.resw0 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        #self.resw1 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
        self.resw2 = ResBlockTranspose(ngf*2, ngf*2, 129, 1, 64)
        ...
        self.resp2 = ResBlockTranspose(ngf*2, ngf*2, 129, 1, 64)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw1 = ResBlock(ndf*2, ndf*2, 129, 1, 64, padding_mode='circular')
        ...
        self.resp1 = ResBlock(ndf*2, ndf*2, 129, 1, 64, padding_mode='circular')
        ...
        self.res1 = ResBlock(ndf*4, ndf*4, 17, 1, 8, padding_mode='circular')
