...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv0 = nn.Conv1d(geom_dim, n64, 3, 1, 0)

        self.conv1 = nn.Conv1d(n64, n128, 12, 4, 0)

        self.conv2 = nn.Conv1d(n64+n128, n256, 8, 2, 0)
        self.conv3 = nn.Conv1d(n256, n512, 8, 2, 0)
        self.conv4 = nn.Conv1d(n256+n512, n512, 8, 2, 0)
