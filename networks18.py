...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.res6 = ResBlockTranspose(ngf*4, ngf*4, 257, 1, 128)
        self.res7 = ResBlockTranspose(ngf*4, ngf*2, 1025, 1, 512)
        ...
        self.resw3 = ResBlockTranspose(ngf*2, n_wires, 17, 1, 8)
        ...
        self.resp3 = ResBlockTranspose(ngf*2, n_features, 17, 1, 8)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = ResBlock(n_wires, ndf*2, 17, 1, 8, padding_mode='circular')
        ...
        self.resp0 = ResBlock(n_features, ndf*2, 17, 1, 8, padding_mode='circular')
        ...
        self.res1 = ResBlock(ndf*4, ndf*4, 1025, 1, 512, padding_mode='circular')
        self.res2 = ResBlock(ndf*4, ndf*6, 257, 1, 128, padding_mode='circular')
