...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.convw3 = nn.Conv1d(ngf*2, n_wires, 513, 1, 256)
        ...
        self.convp3 = nn.Conv1d(ngf*2, n_features, 33, 1, 16)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw0 = ResBlock(2, ndf*2, 513, 1, 256, padding_mode='zeros')
        self.resw1 = ResBlock(ndf*2, ndf*2, 17, 1, 8, padding_mode='zeros')

        self.resp0 = ResBlock(n_features, ndf*2, 33, 1, 16, padding_mode='zeros')
