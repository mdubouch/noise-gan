...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.rw2 = ResBlock(n64)
        self.rw3 = ResBlockDown(n64)
        self.rw4 = ResBlockDown(n64*2)

        self.convg1 = nn.Conv1d(geom_dim, n64, 129, 1, 64, padding_mode='circular')
        self.rg2 = ResBlock(n64)
        self.rg3 = ResBlockDown(n64)
        self.rg4 = ResBlockDown(n64*2)

        self.convp1 = nn.Conv1d(n_features, n64, 129, 1, 64, padding_mode='circular')
        self.rp2 = ResBlock(n64)
        self.rp3 = ResBlockDown(n64)
        self.rp4 = ResBlockDown(n64*2)
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x = self.act(self.bc1(self.dropout(x0)))
