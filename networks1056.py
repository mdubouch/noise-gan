...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.conv2 = nn.Conv1d(n512//8, n512//8, 3, 1, 3, dilation=3)
        self.bn2 = nn.InstanceNorm1d(n512//8)
        self.conv3 = nn.Conv1d(n512//8, n512//8, 3, 1, 9, dilation=9)
        self.bn3 = nn.InstanceNorm1d(n512//8)
        self.conv4 = nn.Conv1d(n512//8, n512//8, 3, 1, 27, dilation=27)
        self.bn4 = nn.InstanceNorm1d(n512//8)
        self.conv5 = nn.Conv1d(n512//8, n512//8, 3, 1, 81, dilation=81)
        self.bn5 = nn.InstanceNorm1d(n512//8)
        self.conv6 = nn.Conv1d(n512//8, n512//8, 3, 1, 243, dilation=243)
        self.bn6 = nn.InstanceNorm1d(n512//8)
        self.conv7 = nn.Conv1d(n512//8, n512//8, 3, 1, 400, dilation=400)
        self.bn7 = nn.InstanceNorm1d(n512//8)

        self.conv8 = nn.Conv1d(n512//8, n512//8, 3, 1, 81, dilation=81)
        self.bn8 = nn.InstanceNorm1d(n512//8)
        self.conv9 = nn.Conv1d(n512//8, n512//8, 3, 1, 27, dilation=27)
        self.bn9 = nn.InstanceNorm1d(n512//8)
        self.conv10 = nn.Conv1d(n512//8, n512//8, 3, 1, 9, dilation=9)
        self.bn10 = nn.InstanceNorm1d(n512//8)
        self.conv11 = nn.Conv1d(n512//8, n512//16, 3, 1, 3, dilation=3)
        self.bn11 = nn.InstanceNorm1d(n512//16)

        self.convw2 = nn.Conv1d(n512//16, n512//32, 7, 1, 3)
        self.convw1 = nn.Conv1d(n512//32, n_wires, 1, 1, 0)

        self.convp2 = nn.Conv1d(n512//16, n512//32, 3, 1, 1)
    ...
    def forward(self, z):
        ...
        x = self.bn7(self.act(self.conv7(x)))

        x = self.bn8(self.act(self.conv8(x)))
        x = self.bn9(self.act(self.conv9(x)))
        x = self.bn10(self.act(self.conv10(x)))
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv2 = nn.Conv1d(n64, n64*2, 3, 1, 3, dilation=3, padding_mode='circular')
        self.conv3 = nn.Conv1d(n64*2, n64*4, 3, 1, 9, dilation=9, padding_mode='circular')
        self.convl13 = nn.Conv1d(n64, n64*4, 1, 1, 0)
        self.conv4 = nn.Conv1d(n64*4, n64*8, 3, 1, 27, dilation=27, padding_mode='circular')
        self.conv5 = nn.Conv1d(n64*8, n64*16, 3, 1, 81, dilation=81, padding_mode='circular')
        self.convl35 = nn.Conv1d(n64*4, n64*16, 1, 1, 0)
        self.conv6 = nn.Conv1d(n64*16, n64*32, 3, 1, 1, dilation=243, padding_mode='circular')

        self.lin0 = nn.Linear(n64*32, 1)
    ...
    def forward(self, x_, xy_, w_): 
        ...
        x = self.act(self.conv2(x1))
        x3 = self.act(self.convl13(x1) + self.conv3(x))
        x = self.act(self.conv4(x3))
        x = self.act(self.convl35(x3) + self.conv5(x))
