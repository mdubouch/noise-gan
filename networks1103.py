...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.bw1 = Simple(n64, n32, 5, 4, 1, output_padding=1)
        self.bw2 = Simple(n32, n16, 3, 2, 1, output_padding=1)

        self.bp1 = Simple(n64, n32, 5, 4, 1, output_padding=1)
        self.bp2 = Simple(n32, n16, 3, 2, 1, output_padding=1)

        self.convp = nn.ConvTranspose1d(n16, n_features-2, 1, 1, 0)
        self.convw = nn.ConvTranspose1d(n16, n_wires, 1, 1, 0)
        self.convwprog = nn.ConvTranspose1d(n16, 2, 1, 1, 0)
        self.out = nn.Tanh()
