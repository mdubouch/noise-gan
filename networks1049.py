...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv2 = nn.Conv1d(n64, n64*2, 3, 1, 1, dilation=6, padding_mode='circular')
        self.conv3 = nn.Conv1d(n64*2, n64*4, 3, 1, 1, dilation=18, padding_mode='circular')

        self.lin0 = nn.Linear(n64*4, 1)
