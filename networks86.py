...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.convw2_diff = nn.Conv1d(ngf*2, ngf*2, 17, 1, 8)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw1 = nn.Conv1d(ndf*1, ndf*2, 17, 1, 8)
        self.resw1_diff = nn.Conv1d(ndf*1, ndf*2, 17, 1, 8)
        ...
        self.res2 = nn.Conv1d(ndf*8, ndf*16, 17, 1, 8)
    ...
    def forward(self, x_): 
        ...
        w = self.act(self.resw2(w + w_diff))
        #w = self.resw2(w)
        #w = self.resw3(w)
