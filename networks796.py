...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim):
        ...
        self.conv1 = nn.Conv1d(n64, n128, 3, 1, 1)
        self.bn1 = nn.InstanceNorm1d(n128)
        self.conv2 = nn.Conv1d(n128, n256, 3, 1, 1)
        self.bn2 = nn.InstanceNorm1d(n256)
        self.conv3 = nn.Conv1d(n256, n512, 3, 1, 1)
        self.bn3 = nn.InstanceNorm1d(n512)
