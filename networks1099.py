...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len, encoded_dim, n_wires):
        ...
        self.conv2 = nn.Conv1d(n32, n64, 3, 1, 1, dilation=3)
        self.conv3 = nn.Conv1d(n64, n128, 3, 1, 1, dilation=9)
        self.conv4 = nn.Conv1d(n128, n256, 3, 1, 1, dilation=27)
        self.conv5 = nn.Conv1d(n256, n512, 3, 1, 1, dilation=81)
