...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len, encoded_dim, n_wires):
        ...
        self.b1 = Simple(n512, 64, 5, 4, 1, output_padding=1)
        self.b2 = Simple(64, 64, 5, 4, 1, output_padding=1)
        self.b3 = Simple(64, 64, 5, 4, 1, output_padding=1)
        self.b4 = Simple(64, 64, 5, 4, 1, output_padding=1)
        self.b5 = Simple(64, 64, 3, 2, 1, output_padding=1)
