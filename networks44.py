...
class Gen(nn.Module):
    def __init__(self, ngf, latent_dims, seq_len):
        ...
        self.resw2 = ResBlockTranspose(ngf*2, ngf*4, 17, 1, 8)
        ...
        self.resp3 = ResBlockTranspose(ngf*2, ngf*2, 17, 1, 8)
...
class Disc(nn.Module):
    def __init__(self, ndf, seq_len):
        ...
        self.resw1 = ResBlock(ndf*4, ndf*2, 17, 1, 8, padding_mode='zeros')

        self.convp = nn.Conv1d(n_features, ndf*1, 1, 1, 0)
        self.resp0 = ResBlock(ndf*1, ndf*2, 17, 1, 8, padding_mode='zeros')
